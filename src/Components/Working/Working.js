      ...
      {props.obj.map((obj) => {
        return (
          <Row
            ...
            className="mt-5 mr-5 pt-5"
          >
            {obj.isLeft ? (
              <>
                <Col className="img-container1 p-0" lg={5} md={12}>
                ...
                <Col
                  lg={5}
                  md={12}
                  className="text-center ml-5 text-container1">
              ...
              <>
                <Col
                  lg={5}
                  className="text-container2 text-center mr-5 pr-4 "
                  md={12}
                >
                  <h3 className="fw-600">{obj.heading}</h3>
                  <h6 className="mt-3 text-left pr-3">{obj.description}</h6>
                </Col>
                <Col className="img-container2 p-0 " lg={5} md={12}>
